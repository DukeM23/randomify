  ...
  return (
    <div className="flex justify-center truncate">
      <div className="my-28 text-center">
        <div className="text-emerald-500 font-semibold text-base sm:text-5xl">
        ...
        <div className="flex justify-center my-10">
          <a
            className="border-2 text-4xl font-semibold rounded-full border-emerald-500 bg-emerald-600 hover:bg-emerald-500 text-gray-900 my-2 px-5 py-4"
